...
Gestiona registro, login, logout y validación de usuarios con Firebase Realtime Database.
"""
...
async def signup(request: SignUpRequest):
    """
    Registra un nuevo usuario en Firebase Realtime Database.
...
async def signin(request: SignInRequest):
    ...
    Verifica las credenciales contra Firebase Realtime Database.
...
async def get_current_user_profile(current_user: dict = Depends(get_current_user)):
    ...
    """
    try:
        # Obtener datos del usuario desde UserService
        user = UserService.get_user_by_id(current_user["uid"])
        ...
        return UserResponse(
            ...
            puntos_fidelizacion=user.get("puntos_fidelizacion", 0),
